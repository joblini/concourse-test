...
fly --target=concourse set-pipeline --pipeline=hello-bar --config=pipeline-bar.yml --load-vars-from params-bar.yml 
fly --target=concourse unpause-pipeline --pipeline=hello-bar
