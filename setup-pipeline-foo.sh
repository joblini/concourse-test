...
fly --target=concourse set-pipeline --pipeline=hello-foo --config=pipeline-foo.yml --load-vars-from params-foo.yml 
fly --target=concourse unpause-pipeline --pipeline=hello-foo
