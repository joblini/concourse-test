...
fly --target=concourse set-pipeline --pipeline=pipeline-foo --config=pipeline-foo.yml --load-vars-from params-foo.yml 
fly --target=concourse unpause-pipeline --pipeline=pipeline-foo
